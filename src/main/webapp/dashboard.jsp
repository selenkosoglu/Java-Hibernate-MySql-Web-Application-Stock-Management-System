        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="d-grid gap-2">
              ...
              <a href="products.jsp" class="btn btn-primary btn-lg mb-2 text-left custom_btn button1" type="button"><i class="fas fa-user-plus"></i> Ürün Ekle</a>
              <a href="boxAction.jsp" class="btn btn-primary btn-lg mb-2 text-left custom_btn button1" type="button"><i class="fas fa-user-plus"></i> Sipariş Ekle</a>
              <a href="checkOutActions.jsp" class="btn btn-primary btn-lg mb-2 text-left custom_btn button1" type="button"><i class="fas fa-user-plus"></i> Ödeme Ekle</a>
            </div>
          </div>
          <div class="col-sm-6">
